function [imgfillmask,BW] = segmentNucleiBen(im, level)
...
BW = activecontour(im, mask, 100, 'Chan-Vese','SmoothFactor',1,'ContractionBias',0);
...
%BW = bwareafilt(BW, [100 30000]); % I'm changing this to see if I eliminate
