function [  ] = figspanelnosave( dapiiso, Vnorm, coloccy3dapi, coloccy5dapi, cy3midcoloc, cy5midcoloc, cy3_spotStats_file )
...
scatter3(coloccy3dapi(coloccy3dapi(:,4) > -10,1),coloccy3dapi(coloccy3dapi(:,4) > -10,2),coloccy3dapi(coloccy3dapi(:,4) > -10,3),'MarkerEdgeColor','yellow','Marker','.');
hold on;
whitebg('black');
scatter3(coloccy5dapi(coloccy5dapi(:,4) > -10,1),coloccy5dapi(coloccy5dapi(:,4) > -10,2),coloccy5dapi(coloccy5dapi(:,4) > -10,3),'MarkerEdgeColor','yellow','Marker','.');
hold on;
scatter3(coloccy5dapi(coloccy5dapi(:,4) < -10,1),coloccy5dapi(coloccy5dapi(:,4) < -10,2),coloccy5dapi(coloccy5dapi(:,4) < -10,3),'MarkerEdgeColor','red','Marker','.');
hold on;
scatter3(coloccy3dapi(coloccy3dapi(:,4) < -10,1),coloccy3dapi(coloccy3dapi(:,4) < -10,2),coloccy3dapi(coloccy3dapi(:,4) < -10,3),'MarkerEdgeColor','red','Marker','.');
hold on;
pd = patch(dapiiso);
Vnorm;
pd.FaceColor = 'blue';
