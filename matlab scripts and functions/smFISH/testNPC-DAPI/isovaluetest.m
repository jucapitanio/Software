function val = isovaluetest(data)
...
% All I did wa rename this and save it in the folder so I can actually see
% the isovalue being used by the isosurface function.
