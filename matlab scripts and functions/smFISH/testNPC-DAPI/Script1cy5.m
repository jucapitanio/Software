...
createSpotTrainingSet('cy5_Pos30','Nup98')

%% 
load trainingSet_cy5_Nup98.mat
trainingSet=trainRFClassifier(trainingSet);

%% 
load trainingSet_cy5_Nup98.mat
classifySpotsOnDirectory(1,trainingSet,'cy5') % make sure this function has a case with your dye to get assigned to dyeToDo, somehow it can't read from the Aro_paramenters.
...
cy3Spotstats = strcat(rootfolder, '\AnalysisJu\SpotStats\cy5');

cd(cy3Spotstats);
spotStatsDataAligning([date 'cy5'], 0); %For this function, also make sure there is a case that matches your dye used.
